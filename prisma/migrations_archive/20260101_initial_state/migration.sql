...
-- CreateEnum
CREATE TYPE "MaterialRequestStatus" AS ENUM ('REQUESTED', 'ORDERED', 'RECEIVED', 'CANCELLED');
...
CREATE TABLE "GlobalLibrary" (
    ...
    CONSTRAINT "GlobalLibrary_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "GlobalLibrary_internal_code_key" ON "GlobalLibrary"("internal_code");
...
-- AddForeignKey
ALTER TABLE "GlobalLibrary" ADD CONSTRAINT "GlobalLibrary_vendor_id_fkey" FOREIGN KEY ("vendor_id") REFERENCES "Vendor"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectSchedule" ADD CONSTRAINT "ProjectSchedule_original_library_id_fkey" FOREIGN KEY ("original_library_id") REFERENCES "GlobalLibrary"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectSchedule" ADD CONSTRAINT "ProjectSchedule_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ProjectScheduleOption" ADD CONSTRAINT "ProjectScheduleOption_material_item_id_fkey" FOREIGN KEY ("material_item_id") REFERENCES "GlobalLibrary"("id") ON DELETE SET NULL ON UPDATE CASCADE;
