      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-50/50 hover:bg-slate-50/50">
            <TableHead className="font-sans font-semibold text-slate-900">Brand</TableHead>
            <TableHead className="font-sans font-semibold text-slate-900">Company / Role</TableHead>
            <TableHead className="font-sans font-semibold text-slate-900">Contact</TableHead>
