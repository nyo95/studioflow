...
interface HydrationGuardProps {
  ...
  namespace?: string;   // For debugging
}
...
export function DehydrationDebug() {
  ...
  return (
    <div
      className="fixed bottom-4 right-4 max-w-sm rounded-lg border border-blue-200 bg-blue-50 p-3 text-xs font-mono text-blue-900 z-50"
      style={{ opacity: 0.9 }}
    >
