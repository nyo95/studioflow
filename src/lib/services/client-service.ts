...
export const clientService = {
  ...
  async executeDeleteClient(tx: PrismaTransaction, params: { clientId: string; userId: string }) {
    ...
    await insertAuditLog(tx, "deleteClient", "Client", client.id, userId, { name: client.name });
  ...
  async executeMergeClients(
    ...
    await insertAuditLog(tx, "mergeClients", "Client", sourceClient.id, userId, {
  ...
  async executeUpdateClientBranding(
    ...
    await insertAuditLog(tx, "updateClientBranding", "Client", client.id, userId, {
