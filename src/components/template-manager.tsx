        ...
        <>
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              ...
              <h3 className="font-serif text-xl font-bold text-slate-900">Per-Phase Defaults</h3>
            </div>
          ...
          <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="space-y-1">
                ...
                <h3 className="font-serif text-2xl font-bold text-slate-900">Categories & Prefixes</h3>
                ...
                return (
                  <div key={section} className="flex flex-col rounded-2xl border border-slate-100 bg-slate-50/30">
                    <div className="flex items-center justify-between border-b border-slate-100 p-4">
                      <div>
                        <h4 className="font-serif text-lg font-bold text-slate-900">{sectionLabel} Categories</h4>
                        <p className="text-[11px] font-medium uppercase tracking-widest text-slate-400">
