...
| Berkas | Isinya |
|---|---|
| `AGENTS.md` | Kontrak & aturan kerja, berlaku Claude maupun Codex. **Dibaca pertama.** §🧱 Master Data Contract (v2) adalah kontrak domain yang berlaku; §🧑‍⚖️ Pembagian Peran mengatur siapa menulis kode; §graphify mengatur pemakaian knowledge graph. |
...
menemukan empat hal baru. Ditulis Claude sebagai roadmap untuk Codex — belum
...
- [ ] **BR11 · Hapus inline edit tabel Brands, ringkas kolom Category/Hashtag
      (P1)** — permintaan eksplisit owner 2026-08-19: menu kebab sudah punya
...
- [ ] **BR12 · Konsistensi styling & interaksi tabel Brands vs Suppliers (P2)**
      — owner minta kedua tabel "perlakuannya sama". UI-CON-4 sudah
