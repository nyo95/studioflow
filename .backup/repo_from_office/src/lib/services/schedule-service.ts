...
export class ScheduleService {
  ...
  static async addEntryToSchedule(
    ...
    if (mode === "reserve" || mode === "catalog" || mode === "create_catalog") {
      // No sync needed - material is either already in library or doesn't exist yet
    } else {
  ...
  static async addOptionToEntry(
    ...
    // 5. Automatic Sync (Auto-Harvesting) - Skip for RESERVE to prevent ghost vendors
