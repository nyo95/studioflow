      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-50/50 hover:bg-slate-50/50 h-12">
            ...
            {!isReviewMode && <TableHead className="font-inter font-bold text-[10px] uppercase tracking-wider text-slate-400">Price</TableHead>}
            ...
            <TableRow key={m.id} className="hover:bg-slate-50/30 group transition-colors border-slate-50 h-16">
              ...
              <TableCell>
                <div className="flex flex-col gap-0.5">
                  <span className="font-lora font-medium text-slate-900 text-sm">{m.product_type}</span>
                  <span className="text-[10px] text-slate-400 font-inter font-medium truncate max-w-[150px]">
                    {m.motif_or_color || "No Variant"} {m.finishing ? `· ${m.finishing}` : ""}
                  </span>
                </div>
              </TableCell>
              <TableCell>
              ...
              <TableCell>
                <div className="flex flex-col gap-0.5">
                  <span className="text-[10px] font-black uppercase tracking-tight text-slate-900 font-inter">{m.category}</span>
                  {m.sub_category && <span className="text-[9px] text-slate-400 font-inter">{m.sub_category}</span>}
                </div>
              </TableCell>
              {(!isReviewMode) && (
                  <TableCell>
