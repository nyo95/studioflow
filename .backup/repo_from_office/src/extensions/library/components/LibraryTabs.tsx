          ...
          <Card className="border-slate-200 bg-white shadow-sm overflow-hidden rounded-lg">
            ...
            <CardContent className="p-5 space-y-5">
              <div className="flex flex-col gap-3">
                 <h2 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 font-inter">Quick Search</h2>
              ...
              <div className="flex flex-col gap-3">
                 <h2 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 font-inter">Filter Category</h2>
              ...
              <div className="flex flex-col gap-3">
                 <h2 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 font-inter">Availability</h2>
            ...
            <Button 
              ...
              className="w-full bg-slate-900 hover:bg-slate-800 text-white font-inter text-xs h-11 px-4 rounded-lg shadow-sm flex items-center justify-center gap-2 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
            >
                  ...
                  <>
                    ...
                    <TabsTrigger value="review" className="relative pb-4 rounded-none border-b-2 border-transparent data-[state=active]:border-slate-900 data-[state=active]:bg-transparent shadow-none px-2 transition-all group shrink-0">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-lora text-sm md:text-base font-medium text-slate-500 group-data-[state=active]:text-slate-900 underline decoration-orange-200 decoration-2 underline-offset-4">Inbox/Review</span>
                      </div>
                    </TabsTrigger>
                  </>
                )}
          ...
          <TabsContent value="review" className="mt-0 focus-visible:outline-none focus-visible:ring-0 min-h-[500px]">
            <div className="mb-6 p-4 bg-orange-50/50 border border-orange-100 rounded-lg flex items-center gap-4 animate-in slide-in-from-top-2 duration-500">
              ...
              <div className="flex flex-col">
                <span className="text-xs font-bold text-orange-900 font-inter">Inbox/Review Management</span>
