...
export default function LibraryPage() {
  ...
  return (
    <DashboardPageShell className="max-w-none px-6">
      <div className="space-y-8 animate-in fade-in duration-700">
        <PageHeader
          eyebrow="Extension // Pillar 2"
          title="Digital Library"
          description="A curated catalog of materials and physical sample tracking with e-commerce aesthetics."
        />
